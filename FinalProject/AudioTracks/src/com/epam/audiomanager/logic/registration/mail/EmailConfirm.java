...
import com.epam.audiomanager.util.SessionCreator;
...
public class EmailConfirm extends Thread {

    private static final Logger LOG = LogManager.getLogger(EmailConfirm.class);
    ...
    public EmailConfirm(String sendToEmail, String mailSubject, String mailText,
