    ...
    <div class="row content">
        <div class="col-sm-3 sidenav hidden-xs">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#section1"><fmt:message key="label.main"/></a></li>
                <li><a href="#section2"><fmt:message key="label.search"/></a></li>
                <li><a href="#section3"><fmt:message key="label.profile"/></a></li>
